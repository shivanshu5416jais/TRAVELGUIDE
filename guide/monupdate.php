...
{   $name=$_POST['name'];
	$address=$_POST['address'];
		...
		$about=$_POST['about'];
	echo $name;
	$query="UPDATE monuments SET name='$name',address='$address',contact='$contact'  ,about='$about' WHERE name='$name1' AND address='$address1'";
	...
	header("refresh:2;url=mondelete.php");
		...
		echo "<font color='red'>record update not sucessful.<a href='mondelete.php'>CHECK UPDATE";
	}
else
{
}
