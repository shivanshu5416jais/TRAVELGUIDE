...
if (mysqli_num_rows($resul) > 0) 
               ...
               $row = mysqli_fetch_assoc($resul);
                 $id=$row["id"];
//echo $id;
                 $sql="SELECT * FROM monuments where id='$id' AND name='$name1' AND address='$address'";
                ...
                // output data of each row
                  ...
                  else
                  {
                   ...
                   $sql="INSERT INTO monuments (id,name,address,contact,image,about) VALUES('$id','$name1','$address','$contact','$name','$about');";
                   $result=mysqli_query($conn,$sql);
                    $location='uploads/';
