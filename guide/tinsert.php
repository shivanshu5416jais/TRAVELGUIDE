...
require('edittemples.php');
  if (isset($_SESSION['admin'])) {
  		echo'<form action="tinsert.php" method="post" >';
...
if (mysqli_num_rows($resul) > 0) {
    ...
    $id=$row["id"];
   // echo $id;
    $sql="SELECT * FROM temples where id='$id' AND name='$name' AND address='$address'";
    ...
    {
    $sql="INSERT INTO temples (id,name,address,contact) VALUES('$id','$name','$address','$contact');";
$result=mysqli_query($conn,$sql);
}
