  ...
  $a=$_SESSION['id'];
   ...
   if (mysqli_num_rows($result) > 0)  
   {
    // output data of each row
     ...
     //      $id=$row["name"];
    	// $a=$row["image"];
    	echo '<div style="width:100%;height:300px;"><a style="height:300px;width:48%;float:left;border:2px solid black; border-radius:20px;" href="hinfo.php?id=' . $row["image"] . '"><div style="height:300px;width:100%;float:left;border:2px solid black;border-radius:20px;">';
